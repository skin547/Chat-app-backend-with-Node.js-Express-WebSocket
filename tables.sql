...
create table room_user ( roomId char(36), userId char(36), FOREIGN Key(roomId) REFERENCES rooms(id) ON DELETE SET NULL , FOREIGN Key(userId) REFERENCES users(id) ON DELETE SET NULL );